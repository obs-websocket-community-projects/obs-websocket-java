...
public class FiltersEventsSerializationTest extends AbstractEventSerializationTest {
  ...
  void sourceFilterRemovedEvent() {
    assertEventType(TYPE, new SourceFilterRemovedEvent(
        SourceFilterRemovedEvent.SpecificData.builder()
            .sourceName("SomeName")
            .filterName("FilterName")
            .build()));
  }
  ...
  void sourceFilterNameChangedEvent() {
    assertEventType(TYPE, new SourceFilterNameChangedEvent(
        SourceFilterNameChangedEvent.SpecificData.builder()
            .sourceName("SomeName")
            .filterName("FilterName")
