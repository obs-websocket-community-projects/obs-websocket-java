...
public class SetSceneTransitionOverrideRequest extends SceneRequest {
    ...
    @Builder
    private SetSceneTransitionOverrideRequest(String sceneName, String transitionName, Integer transitionDuration) {
        super(Type.SetSceneTransitionOverride);

        this.requestData = Data.builder().sceneName(sceneName).transitionName(transitionName).transitionDuration(transitionDuration).build();
    }
