...
public class GeneralRequestsSerializationTest extends AbstractSerializationTest {
    ...
    void broadcastCustomEventRequest() {
        ...
        Assertions.assertThat(actualObject.getRequestId()).isEqualTo(broadcastCustomEventRequest.getRequestId());
        Assertions.assertThat(actualObject.getRequestType()).isEqualTo(Request.Type.BroadcastCustomEvent);
