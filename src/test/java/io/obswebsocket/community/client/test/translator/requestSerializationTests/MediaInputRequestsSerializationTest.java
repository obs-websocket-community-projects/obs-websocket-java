...
public class MediaInputRequestsSerializationTest extends AbstractSerializationTest {
    ...
    void nextMediaInputPlaylistItemRequest() {
        NextMediaInputPlaylistItemRequest nextMediaInputPlaylistItemRequest = NextMediaInputPlaylistItemRequest.builder()
                .inputName("Media Input")
                .build();
    ...
    void previousMediaInputPlaylistItemRequest() {
        PreviousMediaInputPlaylistItemRequest previousMediaInputPlaylistItemRequest = PreviousMediaInputPlaylistItemRequest.builder()
                .inputName("Media Input")
                .build();
    ...
    void offsetMediaInputTimecodeRequest() {
        OffsetMediaInputTimecodeRequest offsetMediaInputTimecodeRequest = OffsetMediaInputTimecodeRequest.builder()
                .inputName("Media Input")
    ...
    void setMediaInputTimecodeRequest() {
        SetMediaInputTimecodeRequest setMediaInputTimecodeRequest = SetMediaInputTimecodeRequest.builder()
                .inputName("Media Input")
    ...
    void setMediaInputPauseStateRequest() {
        SetMediaInputPauseStateRequest setMediaInputPauseStateRequest = SetMediaInputPauseStateRequest.builder()
                .inputName("Media Input")
                .pause(false)
                .build();
