...
public class OutputRequestsSerializationTest extends AbstractSerializationTest {
    ...
    void getReplayBufferStatusRequest() {
        GetReplayBufferStatusRequest getReplayBufferStatusRequest = GetReplayBufferStatusRequest.builder().build();
    ...
    void toggleReplayBufferRequest() {
        ToggleReplayBufferRequest toggleReplayBufferRequest = ToggleReplayBufferRequest.builder().build();
