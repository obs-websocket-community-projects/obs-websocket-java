...
public class StreamRequestsSerializationTest extends AbstractSerializationTest {
    ...
    void getStreamServiceSettingsRequest() {
        GetStreamServiceSettingsRequest getStreamServiceSettingsRequest = GetStreamServiceSettingsRequest.builder().build();
    ...
    void setStreamServiceSettingsRequest() {
        ...
        SetStreamServiceSettingsRequest setStreamServiceSettingsRequest = SetStreamServiceSettingsRequest.builder()
        ...
        SetStreamServiceSettingsRequest actualObject = translator.fromJson(json, SetStreamServiceSettingsRequest.class);

        assertThat(actualObject.getRequestData().getServiceSettings().get("randomStringSetting").getAsString()).isEqualTo(setStreamServiceSettingsRequest.getRequestData().getServiceSettings().get("randomStringSetting").getAsString());
        assertThat(actualObject.getRequestData().getServiceSettings().get("randomBooleanSetting").getAsBoolean()).isEqualTo(setStreamServiceSettingsRequest.getRequestData().getServiceSettings().get("randomBooleanSetting").getAsBoolean());
        assertThat(actualObject.getRequestData().getServiceSettings().get("randomIntegerSetting").getAsInt()).isEqualTo(setStreamServiceSettingsRequest.getRequestData().getServiceSettings().get("randomIntegerSetting").getAsInt());
        assertThat(actualObject.getRequestId()).isEqualTo(setStreamServiceSettingsRequest.getRequestId());
